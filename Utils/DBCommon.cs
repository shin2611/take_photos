...
namespace Utils
{
    ...
    public sealed class DBCommon
    {
        ...
        public static string MakeRewriteUrl(string rewriteUrl, int cateId)
        {
            ...
            return Config.URL_ROOT + m_UrlUtils.Encode() + "/" + rewriteUrl + "/index.htm";
        }
        public static string MakeRewriteUrl(string rewriteUrl, int cateId, long itemId)
        {
            ...
            return Config.URL_ROOT + m_UrlUtils.Encode() + "/" + rewriteUrl + ".htm";
        }
        ...
        /// <summary>
        /// Converts from string to list string.
        /// </summary>
        /// <param name="text">The text want to convert to list string.</param>
        /// <returns></returns>
        public static List<string> ConvertToListString(string text)
        {
            ...
            if (text.Contains("]")) text = text.Replace("]", "");
            if (text.Contains('"')) text = text.Replace(Convert.ToString('"'), "");

            if (text.Contains(Convert.ToString(",")))
            {
                array = text.Split(Convert.ToChar(",")).ToList();
            }
            else
            {
                if (!String.IsNullOrEmpty(text))
